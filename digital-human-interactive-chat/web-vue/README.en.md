...
# Digital Human Interactive Chat - Web Vue Client

This example demonstrates the Web Vue client engaging in real-time interactive conversations with digital humans.
...
web-vue/
├── src/
│   ├── App.vue                  # Main component, contains complete interaction flow
│   ├── main.js                  # Entry file
